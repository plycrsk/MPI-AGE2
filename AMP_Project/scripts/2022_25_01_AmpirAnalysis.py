...
data = pd.read_csv("output/ampir_predictions.csv")
...
data.to_csv("output/ampir_predictions_nonan.csv")
...
fig = displot_all.fig
fig.savefig("plots/2022_01_25_displot_allProteins_Ampir.pdf") 
...
fig = displot_all.fig
fig.savefig("plots/2022_01_25_displot_over0.5_Ampir.pdf")
