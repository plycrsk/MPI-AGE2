...
data <- read.csv("Results/DiffExp_Analysis/DiffExp_age_150821.csv", sep=',')
...
save(gseaGO, file="Results/GSEA_Analysis/ego_GSEA_Simplified_RemovedRedundantGenes_age_220921.rda")
...
write.csv(gsea_simple_results, "Results/RemovingFish/GSEA/gsea_simplified_results_RemovedRedundantGenes_age_220921.csv")

## Plotting ##

ego_summary <- read.csv("Results/RemovingFish/GSEA/gsea_simplified_results_RemovedRedundantGenes_age_220921.csv")
...
dev.copy2pdf(file = "Results/RemovingFish/GSEA/gseGO_dotplot_Enriched_RemovedRedundantGenes_age_220921.pdf")
...
dev.copy2pdf(file = "Results/RemovingFish/GSEA/gseGO_dotplot_EnrichedOld_RemovedRedundantGenes_age_220921.pdf")

ggsave(
  "Results/RemovingFish/GSEA/gseGO_dotplot_Enriched_RemovedRedundantGenes_age_220921.png",
  plot = last_plot(),
  device = NULL,
  path = NULL,
  scale = 1,
