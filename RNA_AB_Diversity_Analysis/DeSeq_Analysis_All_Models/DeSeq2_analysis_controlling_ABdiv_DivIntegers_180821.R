...
write.csv(results, "DiffExp_age_plus_div_Q0.00_180821.csv")
#write.csv(coeffs, "DiffExp_age_plus_div_Q0.00_coefficients_150821.csv")
...
write.csv(sigOE, "SignificantGenes_age_plus_div_Q0.00_170821.csv")
