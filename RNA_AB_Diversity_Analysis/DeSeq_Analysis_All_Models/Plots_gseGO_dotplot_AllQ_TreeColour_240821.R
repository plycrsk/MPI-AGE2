...
ego_summary <- read.csv("Results/GSEA_Analysis/gsea_simplified_results_Q0.00_WithGOTreeFinal_220821.csv")
...
ego_summary2 <- read.csv("Results/GSEA_Analysis/gsea_simplified_results_Q1.00_WithGOTreeFinal_220821.csv")
...
ego_summary3 <- read.csv("Results/GSEA_Analysis/gsea_simplified_results_Q1.50_WithGOTreeFinal_220821.csv")
...
ego_summary4 <- read.csv("Results/GSEA_Analysis/gsea_simplified_results_Q2.00_WithGOTreeFinal_220821.csv")
...
ego_summary5 <- read.csv("Results/GSEA_Analysis/gsea_simplified_results_Q3.00_WithGOTreeFinal_220821.csv")
...
ego_summary6 <- read.csv("Results/GSEA_Analysis/gsea_simplified_results_Q4.00_WithGOTreeFinal_220821.csv")
...
dot_df_up <- dot_df_up %>% mutate(Immune = case_when(immune_system_processes == TRUE | inflammatory_response == TRUE
                                        | regulation_of_immune_system_processes == TRUE | regulation_of_inflammatory_response == TRUE ~ "Immune"))
...
dev.copy2pdf(file = "gseGO_dotplot_QALL_coloured_top15_upregulated_Simplified_220821.pdf")

ggsave(
  "gseGO_dotplot_QALL_coloured_top15_upregulated_Simplified_220821.png",
  plot = last_plot(),
  device = NULL,
  path = NULL,
  scale = 1,
...
dev.copy2pdf(file = "gseGO_dotplot_QALL_coloured_top15_downregulated_Simplified_220821.pdf")

ggsave(
  "gseGO_dotplot_QALL_coloured_top15_downregulated_Simplified_220821.png",
  plot = last_plot(),
  device = NULL,
  path = NULL,
  scale = 1,
