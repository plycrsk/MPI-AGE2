...
data <- read.csv("Results/GSEA_Analysis/gsea_simplified_results_RemovedRedundantGenes_Q4.00_060921.csv")
...
write.csv(data, "Results/GSEA_Analysis/gsea_simplified_results_RemovedRedundantGenes_Q4.00_7GOterms_160921.csv")
