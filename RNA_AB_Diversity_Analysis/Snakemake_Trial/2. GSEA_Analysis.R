...
## Note: replace diversity order, e.g. Q0.00, with desired diversity order ##
## throughout this R code                                                  ##

data <- read.csv("DeSeq_Analysis_All_Models/Results/DiffExp_Analysis/DiffExp_age_plus_div_Q0.00_150821.csv", sep=',')
...
save(gseaGO, file="Results/GSEA_Analysis/ego_GSEA_Simplified_age_plus_div_RemovedRedundantGenes_Q0.00_060921.rda")
...
write.csv(gsea_simple_results, "Results/RemovingFish/GSEA/gsea_simplified_results_RemovedRedundantGenes_Q0.00_060921.csv")

## Plotting ##

ego_summary <- read.csv("Results/RemovingFish/GSEA/gsea_simplified_results_RemovedRedundantGenes_Q0.00_060921.csv")
...
dev.copy2pdf(file = "Results/RemovingFish/GSEA/gseGO_dotplot_Enriched_RemovedRedundantGenes_Q0.00_060921.pdf")

ggsave(
  "Results/RemovingFish/GSEA/gseGO_dotplot_Enriched_RemovedRedundantGenes_Q0.00_060921.png",
  plot = last_plot(),
  device = NULL,
  path = NULL,
  scale = 1,
