...
data <- read.csv("DeSeq_Analysis_All_Models/Results/GSEA_Analysis/gsea_simplified_results_RemovedRedundantGenes_age_220921.csv")
...
write.csv(data, "DeSeq_Analysis_All_Models/Results/GSEA_Analysis/gsea_simplified_results_RemovedRedundantGenes_9GOterms__ageOnly_161121.csv")
