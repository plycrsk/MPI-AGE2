...
ego_summary <- read.csv("Output/GSEA_analysis/gsea_simplified_results_ImmuneTerms_Q0.00.csv")
...
ego_summary2 <- read.csv("Output/GSEA_analysis/gsea_simplified_results_ImmuneTerms_Q1.00.csv")
...
ego_summary3 <- read.csv("Output/GSEA_analysis/gsea_simplified_results_ImmuneTerms_Q1.50.csv")
...
ego_summary4 <- read.csv("Output/GSEA_analysis/gsea_simplified_results_ImmuneTerms_Q2.00.csv")
...
ego_summary5 <- read.csv("Output/GSEA_analysis/gsea_simplified_results_ImmuneTerms_Q3.00.csv")
...
ego_summary6 <- read.csv("Output/GSEA_analysis/gsea_simplified_results_ImmuneTerms_Q4.00.csv")
...
dev.copy2pdf(file = "Figures/gseGO_dotplot_QALL_top10_upregulated.pdf")

ggsave(
  "Figures/gseGO_dotplot_QALL_top10_upregulated.png",
  plot = last_plot(),
  device = NULL,
  path = NULL,
  scale = 1,
...
dev.copy2pdf(file = "Figures/gseGO_dotplot_QALL_top10_downregulated.pdf")

ggsave(
  "Figures/gseGO_dotplot_QALL_top10_downregulated.png",
  plot = last_plot(),
  device = NULL,
  path = NULL,
  scale = 1,
